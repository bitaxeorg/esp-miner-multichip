...
#define TPS546_INIT_IOUT_OC_FAULT_RESPONSE 0xC0  /* ovecurrent -> shut down, no retries */
// #define TPS546_INIT_IOUT_OC_FAULT_RESPONSE 0x00  /* ovecurrent -> keep running without interruption */
